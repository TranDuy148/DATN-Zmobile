<?php 
    ...
    ?>
    <!--::header part start::-->
    <section class="main_menu home_menu" style="position:fixed; top:0; background-color:#ecfdff;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.php"> <img src="img/logoz_mobile.png" alt="logo" style="height: 50px;"> </a>
